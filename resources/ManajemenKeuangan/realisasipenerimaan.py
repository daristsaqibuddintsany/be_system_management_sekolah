...
def create_realisasi_penerimaan_table(cursor):
...
class RealisasiPenerimaanResource:
    ...
    def on_get(self, req, resp):
        ...
        # AUTO CREATE TABLE
        create_realisasi_penerimaan_table(cursor)
    ...
    def on_post(self, req, resp):
        ...
        resp.media = {
            "message": "Data realisasi penerimaan berhasil ditambahkan"
        }

        resp.status = falcon.HTTP_201


class RealisasiPenerimaanByIdResource:
    ...
    def on_delete(self, req, resp, id):
        ...
        cursor.execute("""
        DELETE FROM realisasi_penerimaan
        WHERE id=%s
        """, (id,))
